...
public class FullySpecifiedTestSuite extends TestSuite<Cw1> {
	...
	public FullySpecifiedTestSuite(String input, String testInput) throws ClassNotFoundException {
        ...
        // add test cases
		tests.add(new BinaryTest("Alice's private key", 5, etalon) {
			@Override
		...
		tests.add(new BinaryTest("Bob's private key", 5, etalon) {
			@Override
			public Object expected() {
		...
		tests.add(new BinaryTest("Charlie's private key", 5, etalon) {
			@Override
			public Object expected() {
